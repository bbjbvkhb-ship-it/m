                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            gradient: const LinearGradient(
                                              colors: [
                                                Color(0xFF420000), // Deep crimson red
                                                Color(0xFF160000), // Blackish red
                                              ],
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: const [
                                                    ...
                                                    SizedBox(height: 6),
                                                    Text(
                                                      'بث مباشر للمجالس الحسينية والقصائد والزيارات على مدار الساعة.',
                                                      style: TextStyle(
