...
class MovieCardV2 extends StatefulWidget {
  ...
  @override
  _MovieCardV2State createState() => _MovieCardV2State();
}

class _MovieCardV2State extends State<MovieCardV2> {
  final FocusNode _focusNode = TvFocusHelper.createFocusNode(debugLabel: true, debugLabelSuffix: 'movie_card');
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text(
                    widget.movie.title,
                    style: TextStyle(
                      color: _isFocused ? primary : onSurface,
                      fontWeight: FontWeight.bold,
                      fontSize: titleSize,
                      fontFamily: 'Cairo',
                    ),
